...
//     results.forEach(({ name: title, genres, background_image: img, released, parent_platforms: platforms, id, short__screenshots: imgs }) => {
...
//     } catch (error) {
//         console.log(error);
//         modalView.innerHTML = 'Error :(';
//     }
// }

// //Load modal
// const loadModal = (obj1) => {

//     modalView.innerHTML = `<div class="modal__bg">
//     <img src="../assets/images/img/card-pic.png" alt="">
...
//         x="0px" y="0px" viewBox="0 0 841.9 980" xml:space="preserve">
//         <path
//             d="M617.9,980c-5.7,0-11.3,0-17,0c-5-1.2-10-2.1-14.9-3.7c-17.7-5.7-28.4-19.1-37-34.6c-1.5-2.7-3.2-4.2-6.3-4.9
//  c-72.9-16.9-145.5-12.8-218.1,2.1c-1.5,0.3-3.2,1.7-4,3c-14.4,24.7-37.5,35.3-65.9,30.6c-23-3.8-44.7-11.5-66.5-19.3
//  c-24.9-8.9-49.5-18.9-75.6-23.7c-18-3.3-36.2-5.4-54.2-8.7c-14.3-2.6-28.3-6.4-40.7-14.3c-13.2-8.4-16.7-18.4-12-33.4
...
//     </svg>
//     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
//         x="0px" y="0px" viewBox="0 0 475.071 475.071" style="enable-background:new 0 0 475.071 475.071;"
//         xml:space="preserve">
//         <path d="M65.947,153.884c-8.183,0-15.136,2.853-20.844,8.566c-5.708,5.711-8.564,12.562-8.564,20.555v122.772
//  c0,8.179,2.855,15.126,8.564,20.837c5.708,5.712,12.657,8.562,20.841,8.562c8.186,0,15.085-2.851,20.699-8.562
//  c5.618-5.711,8.425-12.658,8.425-20.837V183.005c0-7.996-2.857-14.847-8.565-20.555C80.794,156.74,73.939,153.884,65.947,153.884z
...
//     </svg>
//     <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
//         x="0px" y="0px" viewBox="0 0 22.773 22.773" xml:space="preserve">
//         <path d="M15.769,0c0.053,0,0.106,0,0.162,0c0.13,1.606-0.483,2.806-1.228,3.675c-0.731,0.863-1.732,1.7-3.351,1.573
//  c-0.108-1.583,0.506-2.694,1.25-3.561C13.292,0.879,14.557,0.16,15.769,0z" />
...
//     <svg viewBox="0 0 13 13" xmlns="http://www.w3.org/2000/svg">
//         <path fill-rule="evenodd" clip-rule="evenodd"
//             d="M9.67443 13H7.67506C7.62406 13 7.58325 12.9591 7.58325 12.908V0.081761C7.58325 0.0408805 7.61385 0 7.66486 0H9.67443C11.5106 0 12.9999 1.49214 12.9999 3.33176V9.66824C12.9999 11.5079 11.5106 13 9.67443 13ZM11.4596 7.15409C11.4596 6.42846 10.8679 5.83569 10.1437 5.83569C9.41941 5.83569 8.83796 6.42846 8.82776 7.15409C8.82776 7.87972 9.41941 8.47248 10.1437 8.47248C10.8679 8.47248 11.4596 7.87972 11.4596 7.15409Z" />
//         <path
//             d="M2.16675 4.33333C2.16675 4.92917 2.65425 5.41667 3.25008 5.41667C3.84591 5.41667 4.33341 4.92917 4.33341 4.33333C4.33341 3.7375 3.84591 3.25 3.25008 3.25C2.64522 3.25 2.16675 3.72847 2.16675 4.33333Z" />
//         <path fill-rule="evenodd" clip-rule="evenodd"
//             d="M3.45677 0H6.40457C6.45759 0 6.5 0.0408805 6.5 0.0919811V12.908C6.5 12.9591 6.45759 13 6.40457 13H3.45677C1.54812 13 0 11.5079 0 9.66824V3.33176C0 1.49214 1.54812 0 3.45677 0ZM3.45677 11.9575H5.41843V1.04245H3.45677C2.82055 1.04245 2.22675 1.28774 1.7814 1.71698C1.32545 2.14623 1.08157 2.71855 1.08157 3.33176V9.66824C1.08157 10.2814 1.33605 10.8538 1.7814 11.283C2.22675 11.7225 2.82055 11.9575 3.45677 11.9575Z" />
//     </svg>
//  </div>
...
//     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui, tempora neque mollitia tenetur
//         impedit
//         libero labore consectetur ab culpa voluptates assumenda quia nostrum nam magnam beatae facere
//         deleniti
//         vitae! Lorem ipsum, dolor sit amet
//         consectetur adipisicing elit. Nihil nobis ipsum nesciunt natus ut, voluptatem dignissimos,
//         commodi
//         reprehenderit velit perferendis numquam pariatur mollitia officia tenetur, laudantium quidem
//         vitae
//         delectus odit.
//     </p>
//  </div>
...
//     <div>
//         <img src="../assets/images/img/modal/second.png" alt="Modal first game image">
//     </div>
//     <div>
//         <img src="../assets/images/img/modal/first.png" alt="Modal second game image">
//     </div>
//     <div>
//         <img src="../assets/images/img/modal/first.png" alt="Modal third game image">
//     </div>
//     <div>
//         <img src="../assets/images/img/modal/fourth.png" alt="Modal fourth game image">
//     </div>
//     <div class="modal__img-special">
//         <div>
//         </div>
//         <img src="../assets/images/img/modal/fifth.png" alt="Modal fifth game image">
//         <p>View all</p>
...
//     <div class="bottom__link flex-start-column">
//         <p>Platforms</p>
//         <a>PlayStation 5, PC, Xbox One</a>
//     </div>
//     <div class="bottom__link flex-start-column">
//         <p>Release date</p>
//         <a>May 25, 2021</a>
